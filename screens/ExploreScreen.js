...
const ExploreScreen = () => {
  ...
  return (
    <View style={{ width: "100%", height: "100%", }}>
      ...
      <Text style={{ fontSize: 25, fontWeight: "900", color: "black", left: "6%", top: "4%" }}>
        Explore
      </Text>
        ...
        <View style={{ marginBottom: "2%", bottom: "2%", flexDirection: "row", width: "100%", padding: 9, alignSelf: "center", alignItems: "center" }}>
          ...
          >
            ...
            <View style={{ borderRadius: 10, width: 160, height: 170, marginHorizontal: 5, justifyContent: "center", alignItems: "center" }}>
              <Image style={{ width: 150, height: 100, borderRadius: 10 }} source={{ uri: "https://img.freepik.com/free-photo/hercules-hall-surrounded-by-greenery-sunlight-daytime-munich-germany_181624-17876.jpg?ga=GA1.1.1155509870.1697629433&semt=sph" }} />
              <View style={{ top: "5%" }}>
