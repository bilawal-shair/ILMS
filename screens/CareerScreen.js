    ...
    <View style={{ flex: 1, width: "100%", height: "100%", backgroundColor: "#fff" }}>
      ...
      <ScrollView style={{ marginBottom: "30%", top: "5%" }}>
        ...
        <View style={{ marginBottom: "1%", flexDirection: "row", width: "95%", padding: 10,  alignSelf: "center" }}>
          ...
          <View style={{ justifyContent: "center", alignItems: "center", width: "45%", padding: 15, borderWidth: 1, borderColor: "gray", borderRadius: 10, marginHorizontal: 5 }}>
        ...
        <View style={{ marginBottom: "1%", flexDirection: "row", justifyContent: "center", alignItems: "center", width: "95%", padding: 30, alignSelf: "center" }}>
          ...
          <View style={{ justifyContent: "center", alignItems: "center", width: "35%", padding: 15, borderWidth: 1, borderColor: "gray", borderRadius: 10, marginHorizontal: 2 }}>
            <Text style={{ fontSize: 12, fontWeight: "900", color: "black" }}>
              Data Analyst
            </Text>
          </View>
          ...
          <View style={{ justifyContent: "center", alignItems: "center", width: "45%", padding: 15, borderWidth: 1, borderColor: "gray", borderRadius: 10, marginHorizontal: 2 }}>
            <Text style={{ fontSize: 12, fontWeight: "900", color: "black" }}>
              Data Engineering
            </Text>
          </View>
