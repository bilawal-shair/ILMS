...
const InformationTechnologyScreen = () => {
    ...
    <View style={{ width: "100%", height: "100%", }}>
      ...
      <ScrollView style={{ marginBottom: "30%", top: "5%" }}>
        ...
        <View style={{ flexDirection: "row", width: "95%", padding: 16, alignSelf: "center", justifyContent: "space-between", alignItems: "center" }}>
          <Text style={{ fontSize: 15, fontWeight: "900", color: "black" }} >Information Technology</Text>
        ...
        <View style={{ top: "1%", width: "100%", height: "7%", alignSelf: "center" }}>
          ...
          >
            <TouchableOpacity  style={{ borderRadius: 10, width: "17%", height: "75%", backgroundColor: "#000080", marginHorizontal: 5, justifyContent: "center", alignItems: "center" }}>
              <Text style={{ fontSize: 14, fontWeight: "900", color: "#fff" }}>
               Security
              </Text>
            </TouchableOpacity>
            <TouchableOpacity  style={{ borderRadius: 10, width: "21%", height: "75%", backgroundColor: "#800000", marginHorizontal: 5, justifyContent: "center", alignItems: "center" }}>
              <Text style={{ fontSize: 14, fontWeight: "900", color: "#fff" }}>
               Data Management
              </Text>
            </TouchableOpacity >
            <TouchableOpacity  style={{ borderRadius: 10,width: "21%", height: "75%", backgroundColor: "#006400", marginHorizontal: 5, justifyContent: "center", alignItems: "center" }}>
              <Text style={{ fontSize: 14, fontWeight: "900", color: "#fff" }}>
                Networking
              </Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ borderRadius: 10, justifyContent: "center", alignItems: "center", width: "30%", height: "75%", backgroundColor: "#0000CD", marginHorizontal: 5 }}>
              <Text style={{ fontSize: 14, fontWeight: "900", color: "#fff" }}>
               Support and Operations
              </Text>
            </TouchableOpacity>
            {/* <TouchableOpacity   style={{ borderRadius: 10, width: "21%", height: "75%", backgroundColor: "#008B8B", marginHorizontal: 5, justifyContent: "center", alignItems: "center" }}>
              <Text style={{ fontSize: 14, fontWeight: "900", color: "#fff" }}>
              Cloud Computing
              </Text>
            </TouchableOpacity> */}
        ...
        <View style={{ marginBottom: "2%", top: "5%", flexDirection: "row", width: "95%", padding: 16, alignSelf: "center", justifyContent: "space-between", alignItems: "center" }}>
          <Text style={{ fontSize: 15, fontWeight: "900", color: "black" }} >IT and CloudComputing</Text>
...
export default InformationTechnologyScreen