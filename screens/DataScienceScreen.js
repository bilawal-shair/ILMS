    ...
    <View style={{ width: "100%", height: "100%", }}>
      <ScrollView style={{ marginBottom: "30%", top: "5%" }}>
        ...
        <View style={{ flexDirection: "row", width: "95%", padding: 16, alignSelf: "center", justifyContent: "space-between", alignItems: "center" }}>
          <Text style={{ fontSize: 15, fontWeight: "900", color: "black" }} >Data Science</Text>
        ...
        <View style={{ top: "1%", width: "100%", height: "7%", alignSelf: "center" }}>
          ...
          >
            <TouchableOpacity onPress={()=>navigation.navigate("Art and Humanities")} style={{ borderRadius: 10, width: 170, height: 60, backgroundColor: "#000080", marginHorizontal: 5, justifyContent: "center", alignItems: "center" }}>
              <Text style={{ fontSize: 14, fontWeight: "900", color: "#fff" }}>
               Data Analysis
              </Text>
            </TouchableOpacity>
            <TouchableOpacity  onPress={()=>navigation.navigate("Bussiness")} style={{ borderRadius: 10, width: 120, height: 60, backgroundColor: "#800000", marginHorizontal: 5, justifyContent: "center", alignItems: "center" }}>
              <Text style={{ fontSize: 14, fontWeight: "900", color: "#fff" }}>
              Machine Learning
              </Text>
            </TouchableOpacity >
            <TouchableOpacity onPress={()=>navigation.navigate("Computer Screen")} style={{ borderRadius: 10, width: 190, height: 60, backgroundColor: "#006400", marginHorizontal: 5, justifyContent: "center", alignItems: "center" }}>
              <Text style={{ fontSize: 14, fontWeight: "900", color: "#fff" }}>
        ...
        <View style={{ marginBottom: "2%", top: "5%", flexDirection: "row", width: "95%", padding: 16, alignSelf: "center", justifyContent: "space-between", alignItems: "center" }}>
          <Text style={{ fontSize: 15, fontWeight: "900", color: "black" }} >Get Started Data Science </Text>
